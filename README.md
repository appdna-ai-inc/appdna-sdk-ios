...
Set the dependency rule to **Up to Next Major Version** starting from `1.0.79`.

Or add to your `Package.swift`:

```swift
dependencies: [
    .package(url: "https://github.com/appdna-ai-inc/appdna-sdk-ios.git", from: "1.0.79")
]
```
