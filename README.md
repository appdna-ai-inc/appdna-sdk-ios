...
Set the dependency rule to **Up to Next Major Version** starting from `1.0.78`.

Or add to your `Package.swift`:

```swift
dependencies: [
    .package(url: "https://github.com/appdna-ai-inc/appdna-sdk-ios.git", from: "1.0.78")
]
```
...
- 🐞 **SDK bug or rendering issue** → [open an issue](https://github.com/appdna-ai-inc/appdna-sdk-ios/issues/new/choose) using the bug report template.
- 🆕 **Missing capability / configuration gap** → use the capability gap template on the same page.
- 🔒 **Security vulnerability** → [report privately](https://github.com/appdna-ai-inc/appdna-sdk-ios/security/advisories/new) — see [SECURITY.md](./SECURITY.md). Never in a public issue.
